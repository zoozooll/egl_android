...
import com.aaron.egllib.AppHolder;
...
public class Ball {
            ...
            {// 纵向横向各到一个角度后计算对应的此点在球面上的坐标
                ...
                float y0 = (float) (r 
                        * Math.cos(Math.toRadians(vAngle)) * Math.sin(Math
                        .toRadians(hAngle)));
                float z0 = (float) (r  * Math.sin(Math
                        .toRadians(vAngle)));
                ...
                float y1 = (float) (r 
                        * Math.cos(Math.toRadians(vAngle)) * Math.sin(Math
                        .toRadians(hAngle + angleSpan)));
                float z1 = (float) (r  * Math.sin(Math
                        .toRadians(vAngle)));
                ...
                float z2 = (float) (r  * Math.sin(Math
                ...
                float z3 = (float) (r  * Math.sin(Math
                        .toRadians(vAngle + angleSpan)));
    ...
    public void initShader() {
        // 加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("light.vert",
                AppHolder.getResources());
        // 加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("light.frag",
                AppHolder.getResources());
        // 基于顶点着色器与片元着色器创建程序
    ...
    public void drawSelf() {
        ...
        // 将半径尺寸传入渲染管线
        GLES30.glUniform1f(muRHandle, r );
        //将光源位置传入渲染管线 
